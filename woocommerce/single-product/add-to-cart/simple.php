...
<div class="add-to-cart-3-buttons"><!--add this-->
...
<?php echo __(esc_html( $product->single_add_to_cart_text() ),''); ?>
</button>


<div style="display : flex"> <!--add this-->
<?php echo do_shortcode('[wishlist]'); ?> <!--add this-->
</div> <!--add this-->
